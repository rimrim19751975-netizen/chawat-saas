...
export default function AdminLogin() {
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', minHeight: '100vh', background: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, direction: dir }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <a href="/" style={{ color: '#1a5632', textDecoration: 'none', fontSize: 32, fontWeight: 'bold' }}>🛒 {t('appName')}</a>
          <div style={{ marginTop: 12 }}><LangSwitch style={{ background: '#1a5632' }} /></div>
          <p style={{ color: '#666', marginTop: 8 }}>{t('adminLoginTitle')}</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 24 }}>
          <p style={{ marginBottom: 12 }}><a href="/boutique/register" style={{ color: '#1a5632', fontSize: 15, textDecoration: 'none', fontWeight: 'bold' }}>📋 {t('contactUs')}</a></p>
          <p style={{ color: '#999', fontSize: 13 }}>{t('createBoutiqueDesc')}</p>
          <p style={{ marginTop: 16 }}><a href="/" style={{ color: '#999', fontSize: 13, textDecoration: 'none' }}>{t('returnHome')}</a></p>
        </div>
      </div>
    </div>
  );
